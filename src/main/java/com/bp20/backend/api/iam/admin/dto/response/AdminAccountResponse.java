...
public record AdminAccountResponse(
        ...
        @Schema(description = "마스킹된 관리자 이메일", example = "ad***@bp20.com") String email,
        @Schema(description = "마스킹된 관리자 이름", example = "김*리") String name,
        @Schema(description = "마스킹된 관리자 연락처", example = "010****5678") String phoneNumber,
        @Schema(description = "관리자 역할", example = "ADMIN") UserRole role,
