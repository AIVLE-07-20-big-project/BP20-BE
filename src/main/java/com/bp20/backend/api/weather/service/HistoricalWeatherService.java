...
import com.bp20.backend.api.weather.dto.HistoricalWeatherData;
import com.bp20.backend.api.weather.dto.HistoricalWeatherResponse;
import com.bp20.backend.api.weather.domain.AsosStation;
import com.bp20.backend.api.weather.domain.AsosStationResolver;
...
public class HistoricalWeatherService {
    ...
    private JsonNode requestPage(
        ...
        JsonNode response = kmaWeatherClient.getHistoricalWeather(requestUri);
