...
public class ReviewAnalysisController {
    ...
    @PostMapping("/reviews/monthly-report")
    ...
    @GetMapping("/reviews/monthly-report/status")
    ...
    public ResponseEntity<List<ReviewTrendResponseDto>> getReviewTrend(
            @PathVariable("storeId") Long storeId
    ) {
        return ResponseEntity.ok(reviewAnalysisService.getWeeklyTrend(storeId));
    }
}
