...
public enum ErrorCode {
    ...
    BAD_REQUEST_INVALID_STORE_STATUS(HttpStatus.BAD_REQUEST, "온라인 스토어 상태 변경 요청이 올바르지 않습니다."),
    BAD_REQUEST_INVALID_PRODUCT_STATUS(HttpStatus.BAD_REQUEST, "상품 상태 변경 요청이 올바르지 않습니다."),
    BAD_REQUEST_INVALID_ONLINE_PRODUCT_STATUS(HttpStatus.BAD_REQUEST, "온라인 상품 등록 또는 상태 변경 요청이 올바르지 않습니다."),
    BAD_REQUEST_INVALID_DISCOUNT(HttpStatus.BAD_REQUEST, "온라인 할인 설정이 올바르지 않습니다."),
    BAD_REQUEST_INVALID_BUNDLE(HttpStatus.BAD_REQUEST, "세트상품 설정이 올바르지 않습니다."),
    ...
    NOT_FOUND_ONLINE_DISCOUNT(HttpStatus.NOT_FOUND, "온라인 할인을 찾을 수 없습니다."),
    NOT_FOUND_PRODUCT_BUNDLE(HttpStatus.NOT_FOUND, "세트상품을 찾을 수 없습니다."),
    NOT_FOUND_CUSTOMER(HttpStatus.NOT_FOUND, "고객을 찾을 수 없습니다."),
    NOT_FOUND_CUSTOMER_COUPON(HttpStatus.NOT_FOUND, "고객 쿠폰을 찾을 수 없습니다."),
