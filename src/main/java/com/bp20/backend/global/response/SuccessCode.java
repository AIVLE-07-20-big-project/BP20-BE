...
public enum SuccessCode {
    ...
    SUCCESS_SALES_TARGET_BATCH_START(HttpStatus.OK, "영업 타겟 배치 실행을 시작했습니다."),
    SUCCESS_SALES_TARGET_BATCH_LIST(HttpStatus.OK, "영업 타겟 배치 실행 목록을 조회했습니다."),
    SUCCESS_SALES_TARGET_BATCH_GET(HttpStatus.OK, "영업 타겟 배치 실행 상태를 조회했습니다."),
    SUCCESS_SALES_TARGET_BATCH_APPROVE(HttpStatus.OK, "영업 타겟 배치를 승인했습니다."),
    SUCCESS_SALES_TARGET_BATCH_REJECT(HttpStatus.OK, "영업 타겟 배치를 반려했습니다."),
    SUCCESS_SALES_TARGET_BATCH_CLEANUP(HttpStatus.OK, "방치된 영업 타겟 배치를 정리했습니다."),
    SUCCESS_SALES_TARGET_BATCH_DELETE(HttpStatus.OK, "영업 타겟 배치 이력을 삭제했습니다."),
    ...
    SUCCESS_AI_AGENT_RUN_DETAIL_GET(HttpStatus.OK, "AI 에이전트 실행 상세 결과를 조회했습니다."),
