...
<p align="center">
  카페·소상공인 매장을 위한 AI 기반 매장 운영 플랫폼
</p>

## 1. 프로젝트 소개

카페·소상공인 매장을 위한 **AI 기반 매장 운영 플랫폼 BP20**의 백엔드입니다. 매장과 상품, 주문·매출, 재고, 고객을 통합 관리하고 매출 예측, 리뷰 분석, 영수증 OCR, 상품 이미지 생성 및 영업 타겟 추천 기능을 AI 서버와 연동합니다.

## 2. 주요 기능

- JWT 기반 인증·인가 및 관리자/점주 계정 관리
- 매장, 상품, 재고, 고객, 온라인 판매 및 쿠폰 관리
- 메뉴·주문·주문상세 CSV 업로드와 매출 데이터 집계
- 영수증 OCR, 지출 분석, 예산 및 가계부 리포트
- 리뷰 조회 및 감성 분석
- 날씨 데이터 조회와 날씨 기반 매출 분석
- 신규 가맹점 영업 타겟 추천 및 배치 상태 관리
- AI 상품 이미지 생성 및 S3/로컬 파일 저장
- 관리자 공지, 첨부파일, IAM 감사 로그
